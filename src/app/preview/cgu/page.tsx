        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 2xl:px-10 max-w-4xl">
          ...
          <div className="prose prose-lg max-w-none text-soft-charcoal space-y-10">
            ...
            <section>
              ...
              <p className="leading-relaxed">
                La réservation s&apos;effectue en ligne via la plateforme indiquée sur le site (Picktime ou équivalent) ou par téléphone / WhatsApp au +212 661 77 77 21. La durée minimum de réservation est d&apos;une heure. Au-delà, les réservations se font par tranches de 30 minutes. Les réservations à la demi-journée ou à la journée sont soumises à devis sur demande.
              </p>
            </section>
            <section>
            ...
            <section>
              ...
              <p className="leading-relaxed">
                RJ Studio se réserve le droit de modifier les présentes CGU. Les modifications sont opposables à partir de leur publication sur le site. Pour toute question ou litige, merci de nous contacter à contact@studiorj.ma ou au +212 661 77 77 21. Le droit marocain est applicable.
              </p>
            </section>
          </div>
