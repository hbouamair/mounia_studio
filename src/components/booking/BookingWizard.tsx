        ...
        <AnimatePresence mode="wait">
          ...
          {step === 2 && courseType && sessionMode && (
            <StudioStep
              ...
              onBack={() => setStep(courseType === "private" ? 0 : 1)}
              backLabel={courseType === "private" ? "Type de cours" : "Formule"}
            />
          )}
                              ...
                              <div className="flex items-start gap-3">
                                ...
                                <div className="flex flex-col items-end gap-1.5 shrink-0">
                                  ...
                                  <button
                                    ...
                                    aria-label={`Retirer la location ${index + 1}`}
                                  >
      ...
      >
        ...
        <div className="text-left space-y-3 border-t border-charcoal/5 pt-6">
          ...
          {slots.map((slot, i) => (
            <SummaryRow
              key={`${slot.date}-${slot.startMinutes}`}
              label={isPackage ? `Location ${i + 1}` : "Date & horaire"}
