        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
          <div className="max-w-xl">
            ...
            <p className="text-sm text-soft-charcoal leading-relaxed">
              Le prix affiché sur chaque studio correspond au tarif horaire. Les
              heures pleines s&apos;appliquent aux créneaux indiqués ci-dessous
              ; le reste du temps ouvert est en heures creuses.
            </p>
            <p className="mt-3 text-xs text-soft-charcoal font-medium leading-relaxed">
              Lun-Ven · 17:00–22:00 · Sam-Dim · 11:00–22:00
            </p>
          </div>
